...
return [
    ...
    '2.3.0-beta.6.1' => function ($config) {
        $storage = app(Storage::class);

        if ($storage->has('templates')) {
            // There was a bug in a previous version, where empty values got stored in the templates library.
            $storage->set('templates', array_filter($storage->get('templates')));
        }
